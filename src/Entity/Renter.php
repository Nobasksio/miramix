...
class Renter
{
    ...
    public function getArrayParam($array = ['id','name','link','logo','floor','image']){
        ...
        $departments = $this->getCategories();
        $array_param['map_place'] = '';
        if ($this->getMapPlace()){
            $array_param['map_place'] = $this->getMapPlace()->getId();
        }
        ...
        foreach ($departments as $department){
            $array_param['departments'][] = $department->getName();
            $array_param['departments_id'][] = $department->getId();
        }
...
//        $array_param['name'] = str_replace(array("'", '"'), array("\'", '\"'), $array_param['name']);
//        $array_param['name'] = addslashes( $array_param['name']);
        return $array_param;
