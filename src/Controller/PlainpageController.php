...
class PlainpageController extends BaseController
{
    /**
    ...
    /**
     * @Route("/plainpage2/{linkName}", name="plainpage_show", methods={"GET"})
     */
    public function show($linkName, PlainpageRepository $pr): Response
    {
        ...
        $app_state = json_encode([
            'name_page'=>$plainpage->getName(),
            'text_page'=>$plainpage->getText(),
        ]);
